...
import com.yxtk.R;
import com.yxtk.utils.DimenUtils;
...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, DimenUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = DimenUtils.dp2px(getContext(), DEF_DRAW_SIZE);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mTickPoints[2].x = Math.round((float) getMeasuredWidth() / 30 * 23);
    ...
    private void drawBorder(Canvas canvas) {
        ...
        mFloorPaint.setColor(mFloorColor);
        int radius = mCenterPoint.x - (isChecked() ? 0 : mStrokeWidth - DimenUtils.dp2px(getContext(), 1));
    ...
    private void startUnCheckedAnimation() {
        ...
        ValueAnimator floorAnimator = ValueAnimator.ofFloat(1.0f, 0.6f, 1.0f);
        floorAnimator.setDuration(mAnimDuration);
        floorAnimator.setInterpolator(new LinearInterpolator());
        floorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
